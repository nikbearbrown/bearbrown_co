...
### Bear Brown palette
| Var | Hex | Role | WCAG on #FFFFFF | WCAG on bb1 (#1a0a00) |
|-----|-----|------|-----------------|----------------------|
...
| bb4 | #E8A020 | amber — highlight/callout | 2.4:1 ✗ dark only | 8.7:1 ✓ AAA |
| bb5 | #B5420A | burnt sienna — secondary accent | 5.3:1 ✓ AA | — |
| bb6 | #B8860B | dark goldenrod — muted accent | 3.1:1 ✗ dark only | 4.6:1 ✓ AA large |
| bb7 | #C8A96E | warm tan — borders/decorative | 2.1:1 ✗ decorative only | — |
| bb8 | #F0E6D0 | cream — dark mode text/bg | — | 15.6:1 ✓ AAA |
